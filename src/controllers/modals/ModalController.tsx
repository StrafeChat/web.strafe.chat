...
import SendFriendRequestModal from "./components/SendFriendRequestModel";
...
export const ModalControllerContext = createContext({
  ...
  openCallbackModal: (_name: string, _data: any) =>
    new Promise((res: any) => res),
  modals: [] as {
    name: string;
...
> {
  ...
  closeModal = (name: string, data?: any) => {
    switch (name) {
      case "settings":
        if (this.state.openModals.find((modal) => modal.name == "edit-data"))
          return;
        else
          this.setState((prevState) => ({
            openModals: prevState.openModals.filter(
  ...
  render() {
    return (
      <ModalControllerContext.Provider
        value={{
          modals: this.state.openModals,
          openModal: this.openModal,
          closeModal: this.closeModal,
          openCustomModal: this.openCustomModal,
          openCallbackModal: this.openCallbackModal,
        }}
      >
        <>
